...
export const metadata: Metadata = {
  ...
  description: "SagarNetra AI Privacy Policy — how we collect, use, and protect your data.",
          ...
          <div className="prose-ocean space-y-10">
            <Section id="overview" title="Overview">
              <p>
                ...
                use our website and demo platform, how we use it, and your rights.
              </p>
              <p>
              ...
              <Subsection title="Data you provide">
                <ul>
                  <li>
                    ...
                    upload to the demo. These are processed in memory and are not
            ...
            <Section id="how-we-use" title="How we use your data">
              <ul>
                <li>To provide and operate the sonar analysis demo</li>
