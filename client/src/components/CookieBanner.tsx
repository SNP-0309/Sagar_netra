...
export default function CookieBanner() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Defer the browser-only state update so the first client render matches
      // the server render and the banner does not cause a cascading render.
      timer = setTimeout(() => {
      ...
      }, stored === "accepted" || stored === "rejected" ? 0 : 1200);
    } catch {
